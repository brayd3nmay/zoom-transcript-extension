...
// Read the rate a menu `<li>` represents. Our injected items carry the
// numeric rate on `dataset.rate`; Zoom's native items only have a label
// (`"Normal"` for 1× or e.g. `"1.5x"`).
